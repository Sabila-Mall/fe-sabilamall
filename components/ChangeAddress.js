...
export const ChangeAddress = ({ isMobile }) => {
    ...
    let receiverAddresses = [
        {
            name: "Farahhhhhhhhhh",
            phoneNumber: "088888888888",
            fullAddress: "Jl depok blok AA no. 17 Kota Depok, Sukmajaya, Jawa Barat. 16417"
        },
        {
            name: "Farahhhhhhhhhh",
            phoneNumber: "088888888888",
    ...
    return (
        <Box bgColor={{ base: "gray.50", md: "white" }}>
            <Box mt={{ base: "48px", md: "10px" }} px="16px" borderRadius="20px" boxShadow="md" bgColor="white">
                <Stack dir="column">
                    <Text className="primaryFont" fontSize="16px" fontWeight="bold" color={{ base: "black", md: "orange.500" }}>
                        Alamat Pengirim
                    </Text>
                    ...
                    {pengirim ?
                        <AddressBox
                            ...
                            editAddress={!isMobile ? onOpen : (() => router.push("edit-pengirim-mobile"))}
                ...
                >
                    ...
                    <ModalContent borderRadius="20px" bgColor={{ base: "#F7FAFC", md: "white" }}>
                        ...
                        <ModalCloseButton pos="absolute" top="-15px" right="-15px" borderRadius="50%" color="white" bg="red.600" _hover={{ bg: "red.700" }} />
                        <ModalBody pb={6}>
                            <FormControl>
                                <FormLabel>Nama Lengkap</FormLabel>
                                <Input id="name" value={pengirim.name} onChange={(e) => handleName(e.target.value)} required />

                                <FormLabel mt={4}>Nomor Telepon</FormLabel>
                                <Input id="phoneNumber" value={pengirim.phoneNumber} type="number" onChange={(e) => handlePhone(e.target.value)} required />

                                <FormLabel mt={4}>Alamat Lengkap</FormLabel>
                                <Input id="address" value={pengirim.address} onChange={(e) => handleAddress(e.target.value)} required />
                            </FormControl>
                        </ModalBody>
            ...
            <Box mt={{ base: "100px", md: "20px" }} px="16px" pt="18px" borderRadius="20px" boxShadow="md" bgColor="white">
                <Flex>
                    <Text className="primaryFont" fontSize="16px" fontWeight="bold" color={{ base: "black", md: "orange.500" }}>
                        Alamat Penerima
                    </Text>
