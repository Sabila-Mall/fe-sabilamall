...
export const AddressProvider = ({ children }) => {
    ...
    const addItemPengirim = (customers_id, is_default, address_book_type, entry_firstname, entry_lastname, entry_phone, type) => {
        addAddress({ customers_id, is_default, address_book_type, entry_firstname, entry_lastname, entry_phone })
            .then((res) => {
                console.log(res);
                if (isRequestSuccess(res)) {
                    if (type === "add") {
