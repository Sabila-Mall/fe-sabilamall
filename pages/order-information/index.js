...
const OrderInformation = () => {
    ...
    const notes = "Ini catatan pesanan. Ice cream cake macaroon donut topping tiramisu tart bear claw lemon drops. Pastry lollipop cupcake lemon drops fruitcake gummies dragée liquorice. Halvah apple pie carrot cake gummi bears I love dragée I love marshmallow."
            ...
            <Box
                ...
                >
                    ...
                    >
                        ...
                        <Grid
                            templateColumns={{ base: "repeat(1, 1fr)", md: "repeat(2, 1fr)" }} gap="16px">
                            ...
                            <Box pos="relative" mt={{ base: "24px", md: "" }}>
                                ...
                                <Divider orientation="vertical" pos="absolute" border="1px solid gray.200" h="calc(100% - 90px)" transform="translateY(16px)" my="16px" />
                                <Stack
                                    lineHeight="150%"
                                    className="secondaryFont"
                                    fontFamily="500"
                        ...
                        {isMobile ? <OrderProductsTableMobile products={orderProducts} /> : <OrderProductsTable products={orderProducts} />}
                        <Grid templateColumns={{ base: "repeat(1, fr)", md: "repeat(2, 1fr)" }} pt="16px" gap={4}>
                            {notes ? <Box fontSize="0.875rem" lineHeight="150%">
                            ...
                            <Box color="gray.500" fontSize="0.75rem" lineHeight="150%" className="secondaryFont" fontWeight="500">
                                ...
                                {productDiscount ? <Flex mt="8px">
                                    <Text>Diskon Produk</Text>
                                    <Spacer />
                                    <Text>{productDiscount}</Text>
                                </Flex> : <></>}
                                {voucherDiscount ? <Flex mt="8px">
