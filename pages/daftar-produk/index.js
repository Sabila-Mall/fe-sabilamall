...
const DaftarProduk = () => {
  ...
  function handleLoadMore() {
    ...
    getAllProductsByFilters(newPage, customerId, 'category', null, categoryId, null, null, null)
      .then((res) => {
        setProducts({
  ...
  useEffect(() => {
    categoryId && !authIsLoading && getAllProductsByFilters(1, customerId, 'category', null, categoryId, null, null, null)
      .then((res) => {
        setProducts({
